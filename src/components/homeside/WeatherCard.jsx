...
export default function WeatherCard({
  ...
  return (
    <div className="relative w-[342px] h-[184px] p-5 text-white flex flex-col justify-between rounded-2xl overflow-hidden">
      ...
      {/* Main temperature */}
      <p className="text-[48px] leading-none font-semibold drop-shadow">{temp}</p>

      {/* Info row */}
      <div className="flex items-end justify-between">
        <div className="leading-tight">
          <p className="text-white/60">{highLow}</p>
