...
// const PublicTripDataCard = () => {
//   const navigate = useNavigate();
//   const [privateDatas, setPrivateDatas] = useState<TripResponse | null>(null);
//   const [loading, setLoading] = useState(true);

//   useEffect(() => {
//     const getPrivateFunc = async () => {
//       try {
//         const res = await axios.get<TripResponse>("http://127.0.0.1:8006/Getprivatedata/");
//         setPrivateDatas(res.data);
//         console.log('res data  ', res.data);
//       } catch (error) {
//         console.error("Error fetching experiences:", error);
...
// const TripCard = ({ trip, navigate }: TripCardProps) => {
...
//         <div className="absolute bottom-0 left-0 p-4 text-white">
//           <div className="flex items-center mb-2">
//             <div className="w-10 h-10 rounded-full mr-3 bg-teal-500 flex items-center justify-center">
//               <span className="text-white font-bold text-sm">
//                 {trip.travel_mode.charAt(0).toUpperCase()}
//               </span>
//             </div>
//             <div>
//               <p className="font-bold">{trip.destination_name}</p>
//               <p className="text-xs">
...
//             <p><span className="font-semibold">From:</span> {trip.origin_name}</p>
//             <p><span className="font-semibold">Duration:</span> {trip.trip_duration_days} days</p>
//             <p><span className="font-semibold">Budget:</span> {formatCurrency(trip.total_budget)}</p>
//             <p><span className="font-semibold">Distance:</span> {trip.total_distance_km} km</p>
//             <div className="flex flex-wrap gap-1 mt-1">
//               {trip.trip_types.map((type, index) => (
//                 <span 
//                   key={index}
//                   className="px-2 py-1 bg-teal-600/80 rounded-full text-xs"
//                 >
//                   {type}
//                 </span>
//               ))}
...
//             trip.trip_status === 'ongoing' ? 'bg-green-500' : 
//             trip.trip_status === 'completed' ? 'bg-blue-500' : 
//             'bg-yellow-500'
//           }`}>
//             {trip.trip_status}
//           </span>
...
//           <button 
//             className="bg-teal-500 text-white py-2 px-4 rounded-lg hover:bg-teal-600 transition-colors duration-200"
//             onClick={() => navigate(`/experience/${trip.trip_id}`)}
//           >
//             View Details
//           </button>
//         </div>
