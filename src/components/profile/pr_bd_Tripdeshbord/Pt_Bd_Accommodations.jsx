...
//     // setLoading(true);
//     console.log('prtpidcode   ',prtpidcode)
//     try {
//       const response = await axios.get(`http://127.0.0.1:8006/TripSpecificAPIView/${tripId}/`, {
...
//   // Get accommodations data from trip data
...
//                 Back
//               </button>
//               <h1 className="text-xl font-bold text-gray-900">Trip Accommodations</h1>
//             </div>
...
//                 <span className="text-gray-800 text-sm font-medium leading-normal">
//                   Accommodations for {getDestinationName()}
//                 </span>
//               </div>
...
//                   <h3 className="text-lg font-semibold text-blue-900 mb-2">Trip Summary</h3>
//                   <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
//                     <div>
//                       <span className="font-medium text-blue-800">Total Budget:</span>
//                       <div className="text-blue-600">₹{tripdata.summary.total_budget}</div>
//                     </div>
//                     <div>
//                       <span className="font-medium text-blue-800">Duration:</span>
//                       <div className="text-blue-600">{tripdata.summary.trip_duration_days} days</div>
//                     </div>
//                     <div>
//                       <span className="font-medium text-blue-800">Destination:</span>
//                       <div className="text-blue-600">{getDestinationName()}</div>
//                     </div>
//                     <div>
//                       <span className="font-medium text-blue-800">Hotel Budget:</span>
//                       <div className="text-blue-600">₹{tripdata.summary.estimated_hotel_cost}</div>
//                     </div>
//                   </div>
//                 </div>
//               )}
...
// export default Pt_Bd_Accommodations;
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50">
        <div className="text-lg text-gray-600">Loading accommodations...</div>
      </div>
    );
  }
