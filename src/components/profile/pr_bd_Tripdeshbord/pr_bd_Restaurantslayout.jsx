...
const Pr_bd_Restaurantslayout = () => {
  ...
  // Get restaurants data from API response
  const restaurantsData = tripData?.restaurants || [];
  ...
  const getPriceRange = (restaurant) => {
    if (restaurant.types?.includes('fine_dining_restaurant') || restaurant.rating > 4.5) {
      return '₹₹₹₹';
    } else if (restaurant.types?.includes('cafe') || restaurant.types?.includes('coffee_shop') || restaurant.rating <= 3.0) {
      return '₹₹';
  ...
  const getHighestRating = () => {
    if (uniqueRestaurants.length === 0) return 0;
    return Math.max(...uniqueRestaurants.map(r => r.rating || 0)).toFixed(1);
  };

  // Get nearest restaurant distance
  const getNearestDistance = () => {
    if (uniqueRestaurants.length === 0) return '0.0';
    return uniqueRestaurants[0]?.distance_km?.toFixed(1) || '0.0';
  };
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="flex flex-wrap gap-2 px-4 pb-6">
              <a className="text-gray-500 hover:text-blue-600 text-sm font-medium leading-normal" href="#">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6 p-4">
              ...
              <button className="flex items-center justify-center gap-2 px-5 py-2.5 h-12 rounded-lg bg-blue-600 text-white text-base font-bold leading-normal tracking-tight min-w-[140px] transition-transform hover:scale-105 active:scale-100">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8 p-4">
              ...
              <div className="flex-grow">
                <label className="flex flex-col min-w-40 h-12 w-full">
                  <div className="flex w-full flex-1 items-stretch rounded-lg h-full border border-gray-300 bg-white focus-within:ring-2 focus-within:ring-blue-600 focus-within:border-blue-600">
            ...
            {uniqueRestaurants.length > 0 ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-4 p-5">
                        ...
                        {/* Action Button */}
                        <button className="flex w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-12 px-4 bg-blue-600 text-white text-base font-medium leading-normal transition-all hover:bg-blue-700 hover:scale-105 active:scale-100">
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <button className="flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors">
...
export default Pr_bd_Restaurantslayout;