    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Trip Join Requests</h1>
          <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">Manage and review trip join requests from users</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Public Joins</p>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Invite Only</p>
                <p className="text-xl sm:text-2xl font-semibold text-gray-900">
                  {trips.filter(trip => trip.join_type === 'invite_only').length}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                ...
                <p className="text-xl sm:text-2xl font-semibold text-gray-900">
                  {trips.filter(trip => !trip.is_accepted).length}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <button
              onClick={fetchTrips}
              className="inline-flex items-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors w-full sm:w-auto justify-center"
            >
              <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
          ...
          {trips.length === 0 ? (
            <div className="text-center py-8 sm:py-12">
              ...
              <h3 className="mt-3 sm:mt-4 text-lg font-medium text-gray-900">No trip requests</h3>
              <p className="mt-1 sm:mt-2 text-gray-500 text-sm sm:text-base">There are no pending trip join requests at the moment.</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              {/* Mobile Card View */}
                  ...
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">{trip.name}</div>
                          <div className="text-xs text-gray-500">{trip.email}</div>
                        </div>
                      </div>
                    ...
                    <div className="mb-3 text-xs text-gray-600">
                      <div><span className="font-medium">From:</span> {trip.your_startinglocation}</div>
                      <div>{trip.city}, {trip.state} - {trip.pincode}</div>
                    </div>
                    ...
                    <div className="flex space-x-2">
                      <button
                        onClick={() => openActionModal(trip, 'approve')}
                        className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-transparent text-xs font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
                      >
        ...
        {showModal && selectedTrip && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 p-4">
            <div className="relative top-4 sm:top-20 mx-auto p-5 border w-full max-w-sm sm:max-w-md shadow-lg rounded-md bg-white">
              <div className="mt-3 text-center">
                <div className={`mx-auto flex items-center justify-center h-12 w-12 rounded-full ${actionType === 'approve' ? 'bg-green-100' : 'bg-red-100'}`}>
                  <svg className={`h-6 w-6 ${actionType === 'approve' ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {actionType === 'approve' ? (
        ...
        {selectedTrip && !showModal && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 p-4">
            <div className="relative top-4 sm:top-10 mx-auto p-4 sm:p-5 border w-full max-w-4xl shadow-lg rounded-md bg-white max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center border-b pb-4">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Trip Request Details</h3>
                <button
                  onClick={() => setSelectedTrip(null)}
                  className="text-gray-400 hover:text-gray-600 transition-colors"
                >
              ...
              <div className="mt-4 sm:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <h4 className="text-base sm:text-lg font-medium text-gray-900">User Information</h4>
                  <div className="space-y-2">
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Full Name</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.name}</p>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Email</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.email}</p>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Phone Number</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.phone_number}</p>
                    </div>
                    <div>
                ...
                {/* Trip Information */}
                <div className="space-y-3 sm:space-y-4">
                  <h4 className="text-base sm:text-lg font-medium text-gray-900">Trip Information</h4>
                  <div className="space-y-2">
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Trip Name</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.trip_name}</p>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Join Type</label>
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getJoinTypeBadge(selectedTrip.join_type)}`}>
                        {selectedTrip.join_type === 'public' ? 'Public Join' : 'Invite Only'}
                      </span>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Request Date</label>
                      <p className="text-gray-900 text-sm sm:text-base">{formatDate(selectedTrip.created_at)}</p>
                    </div>
                    {selectedTrip.notes && (
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-600">Additional Notes</label>
                        <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.notes}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {/* Location Information */}
                <div className="space-y-3 sm:space-y-4">
                  <h4 className="text-base sm:text-lg font-medium text-gray-900">Location Details</h4>
                  <div className="space-y-2">
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Starting Location</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.your_startinglocation}</p>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">City & State</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.city}, {selectedTrip.state}</p>
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-600">Pincode</label>
                      <p className="text-gray-900 text-sm sm:text-base">{selectedTrip.pincode}</p>
                    </div>
                    {selectedTrip.address_line && (
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-600">Full Address</label>
                        <p className="text-gray-900 text-sm sm:text-base whitespace-pre-line">{selectedTrip.address_line}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {/* ID Proof */}
                <div className="space-y-3 sm:space-y-4">
                  <h4 className="text-base sm:text-lg font-medium text-gray-900">ID Proof</h4>
                  <div className="space-y-2">
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-3 sm:p-4 flex items-center justify-center">
                      {selectedTrip.aadhaar_image ? (
                        <img
                          src={`http://127.0.0.1:8006${selectedTrip.aadhaar_image}`}
                          alt="ID Proof"
                          className="max-w-full max-h-48 sm:max-h-64 object-contain rounded"
                          onError={(e) => {
                            e.target.src = 'https://via.placeholder.com/300x200?text=Image+Not+Found';
                          }}
                        />
                        ...
                        <div className="text-center text-gray-500">
                          ...
                          <p className="mt-2 text-sm">No ID Proof Uploaded</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3 border-t pt-4">
                <button
                  onClick={() => openActionModal(selectedTrip, 'reject')}
                  className="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors w-full sm:w-auto"
                >
                  Reject Request
                </button>
                <button
                  onClick={() => openActionModal(selectedTrip, 'approve')}
                  className="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors w-full sm:w-auto"
                >
                  Approve Request
                </button>
              </div>
