  ...
  return (
    <nav className="navbar-container">
      ...
      <div className="navbar-menu">
        <button 
          onClick={() => handleNavigation(`/publictrip/${invatetripid}`)} 
        ...
        <button 
          onClick={() => handleNavigation(`/TripSummarylayoutpublic/${invatetripid}`)} 
        ...
        <button 
          onClick={() => handleNavigation(`/Accommodationslayoutpublic/${invatetripid}`)} 
        ...
        <button 
          onClick={() => handleNavigation(`/TravelPlannerRestaurantslayoutpublic/${invatetripid}`)} 
        ...
        <button 
          onClick={() => handleNavigation(`/Attractionslayoutpublic/${invatetripid}`)} 
        ...
        <button 
          onClick={() => handleNavigation(`/DailyItinerarylayoutpublic/${invatetripid}`)} 
        ...
        <button 
          onClick={() => handleNavigation(`/TravelMaplayoutpublic/${invatetripid}`)} 
...
export default PublicTripNavbar;