...
const DailyItinerarylayoutpublic = () => {
      ...
      <div className="bg-white font-display text-gray-900 min-h-screen">
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">No Trip Data Found</h3>
            <p className="text-gray-600">The requested trip itinerary could not be found.</p>
          </div>
        </div>
      </div>
    );
                                        ...
                                        <div className="grid grid-cols-2 gap-2 mt-2">
                                          <div>
                                            ...
                                            <div className="text-xs">
                                              {typeof activity.details.from === 'object' ? 
                                                `${activity.details.from.lat?.toFixed(4)}, ${activity.details.from.lng?.toFixed(4)}` : 
                                          ...
                                          <div>
                                            ...
                                            <div className="text-xs">
                                              {typeof activity.details.to === 'object' ? 
                                                `${activity.details.to.lat?.toFixed(4)}, ${activity.details.to.lng?.toFixed(4)}` : 
                                                activity.details.to}
                                            </div>
                                          </div>
                                        </div>
                ...
                <div className="mt-12 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900 font-medium">{tripData?.origin?.address || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Destination:</span>
                      <span className="text-gray-900 font-medium">{tripData?.destination?.name || tripData?.destination?.address || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Travel Mode:</span>
                      <span className="text-gray-900 font-medium capitalize">{tripData?.travel_mode || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Total Budget:</span>
                      <span className="text-gray-900 font-medium">₹{tripData?.summary?.total_budget || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Trip Type:</span>
                      <span className="text-gray-900 font-medium capitalize">{(tripData?.trip_types || []).join(', ') || 'Not specified'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Budget Category:</span>
                      <span className="text-gray-900 font-medium capitalize">{tripData?.budget_category || 'Not specified'}</span>
                    </div>
                  </div>
                </div>
              )}
...
export default DailyItinerarylayoutpublic;