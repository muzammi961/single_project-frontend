...
//     handleInputChange(e);
//     fetchSuggestions(value, setStartingSuggestions, setShowStartingSuggestions);
//   };

//   const handleDestinationChange = (e) => {
//     const value = e.target.value;
//     handleInputChange(e);
//     fetchSuggestions(value, setDestinationSuggestions, setShowDestinationSuggestions);
//   };
...
//     setTripData(prev => {
//       const currentTypes = prev.placeType;
...
//         setTripData(prev => ({
//           ...prev,
//           startingLocation: `${lat}, ${lng} (Current Location)`
//         }));
//       }, (error) => {
...
//     // Generate appropriate link depending on privacy type
//     if (privacy === 'public') {
//       setInviteLink(`https://pathfinder.com/trip/${Date.now()}`);
//     } else if (privacy === 'invite_only') {
//       setInviteLink(`https://pathfinder.com/invite/${Date.now()}`);
//     } else {
//       setInviteLink('');
//     }
//   };
...
//       setInviteLink(`https://pathfinder.com/trip/${Date.now()}`);
//     } else if (tripData.privacy === 'invite_only') {
//       setInviteLink(`https://pathfinder.com/invite/${Date.now()}`);
//     }
//   };
...
//                           <li
//                             key={idx}
//                             onClick={() => handleSuggestionClick(sug, 'destination', setDestinationSuggestions, setShowDestinationSuggestions)}
...
//                           <li
//                             key={idx}
//                             onClick={() => handleSuggestionClick(sug, 'startingLocation', setStartingSuggestions, setShowStartingSuggestions)}
//                             className="px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm border-b border-gray-100 last:border-b-0"
//                           >
//                             {sug}
//                           </li>
...
//                 {/* Place Type - Multi Select with Checkboxes */}
//                 <label className="flex flex-col md:col-span-2">
...
//                           type="checkbox"
//                           value={type}
//                           checked={tripData.placeType.includes(type)}
...
//                     ))}
//                   </div>
//                   {tripData.placeType.length > 0 && (
//                     <p className="text-sm text-gray-500 mt-2">
//                       Selected: {tripData.placeType.join(', ')}
//                     </p>
//                   )}
//                 </label>
//               </div>
...
//                     name="privacy"
//                     value="invite_only"
//                     checked={tripData.privacy === 'invite_only'}
//                     onChange={(e) => handlePrivacyChange(e.target.value)}
//                   />
//                   <div>
//                     <span className="text-base font-medium text-gray-700">Invite Only</span>
//                     <p className="text-sm text-gray-500">Only invited users can join via link.</p>
//                   </div>
//                 </label>
...
//                     <p className="text-sm text-gray-500">Anyone can join and view this trip.</p>
//                   </div>
//                 </label>
//               </div>

//               {/* Invite Link Display */}
//               {(tripData.privacy === 'public' || tripData.privacy === 'invite_only') && (
//                 <div className="mt-6">
...
//                   </div>
//                   {inviteLink && (
//                     <p className="text-sm text-gray-500 mt-2">Share this link to let others join your trip.</p>
//                   )}
//                 </div>
//               )}
//             </div>
...
//                 Save as Draft
//               </button>
//               <button className="px-8 py-3 rounded-lg bg-blue-600 text-white font-bold hover:bg-blue-700 shadow-lg">
//                 Generate Trip Plan
//               </button>
//             </div>
//           </div>
...
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';  // For redirects if needed
